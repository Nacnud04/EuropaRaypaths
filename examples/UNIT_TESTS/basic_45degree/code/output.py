...
rp.simple_rdrgrm(rdrgrm, params, "figures/rdrgrm.png", title=r"Basic Example at 45$^\circ$", vmin=-20)

focused = sf.full_focus_at_center(rdrgrm, params)

rp.simple_rdrgrm(focused, params, "figures/focused.png", title=r"Basic Example at 45$^\circ$", vmin=0)
